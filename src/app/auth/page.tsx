    ...
    return (
        <section className="brand-surface min-h-[70vh]">
            <div className="container mx-auto px-4 py-10 sm:py-14 max-w-md">
                <div className="brand-panel animate-fade-in p-6 sm:p-7">
                    <div className="text-center mb-7">
                        <p className="brand-kicker">Member Access</p>
                        <h1 className="mt-4 text-3xl font-bold text-text-primary" style={{ fontFamily: 'var(--font-display)' }}>
                            Open Politics
                        </h1>
                    ...
                    {isDev && (
                        <div className="mt-6 border-t border-border-primary pt-6">
                            <p className="text-xs uppercase tracking-[0.16em] text-text-muted mb-3">Development: email/password</p>
